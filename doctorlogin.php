...
if(!empty($_POST['submit'])){
    ...
    $query="SELECT * FROM  doctor WHERE duid='$duid'  and dpassword='$dpassword'";
    $result=mysqli_query($connection,$query);
    $count=mysqli_num_rows($result);
    if($count >0){
      $_SESSION['duid']=$duid;
      header('location:/medicine/Dashboard/doctor.php');
    } else{
...
<html>
    <head>
        <title>Medicine -- Doctor Login</title>
    ...
    <body>
        ...
        <section class="drbody">
            ...
            <div class="drhead">
                ...
                <div class="pr">
                    <h4>Login as Patient <a href="patientlogin.php">Login Here</a></h4>
                </div>
            </div>
            <div class="dr">
                <div class="drimg plmg">
                    
                    <img src="img/medical-5840876.png" alt="">
                </div>
                <div class="drform">
                    
                    <form action="doctorlogin.php" method="POST" class="drfr">
                        
                        <label for="userid">User ID</label>
                        <input type="text" name="uid" id="" placeholder="Enter User ID or email" required>
        ...
        <footer class="footer">
            ...
            <div class="footbottom">
                <h1>Medicine</h1>
                <p>Copyright © 2022, Medicine. All rights reserved.</p>
            </div>
        </footer>
